      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h2 className="text-[30px] md:text-[40px] font-bold text-[#102A43]">
            Quy trình làm việc 6 bước chuẩn nhà máy
          </h2>
          <p className="text-[16px] md:text-[17px] text-[#40566F]">
            Từ ý tưởng và mẫu sản phẩm ban đầu đến lô hàng hoàn chỉnh đạt chuẩn xuất xưởng.
          </p>
        </div>
          ...
          {steps.map((s, idx) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-[20px] font-bold text-[#102A43] mb-2">
                  {s.title}
                </h3>

                <p className="text-[15px] text-[#40566F] leading-relaxed">
                  {s.desc}
                </p>
              </div>
            );
