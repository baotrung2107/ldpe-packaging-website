...
export default function QuoteFormSection({ preselectedProduct }: { preselectedProduct?: string }) {
  ...
  const sectionTitle = getOverride("quote_title", "Bạn chưa biết nên chọn loại LDPE hoặc PE foam nào?");
  const sectionDesc = getOverride(
    "quote_desc",
              ...
              <div className="space-y-3 text-sm text-[#40566F]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a
                      href="tel:0835726666"
                      className="font-bold text-[#102A43] hover:text-[#0B63CE]"
                      data-cms-section="quote_form"
                      data-cms-id="quote_phone"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span
                      ...
                      data-cms-type="text"
                    >
                      Ấp Lập Điền, Xã Tân Mỹ, Huyện Đức Hòa, Tỉnh Long An
                    </span>
                  </div>
                </div>
              </div>
